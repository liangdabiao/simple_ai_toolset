...
from .llm_providers import gemini_llm as gemini_llm
from .llm_providers import anthropic_llm as anthropic_llm
...
class OpenAILLM(LLM):
    ...
    def analyze_image_basic(self, image_url, prompt):
        return openai_llm.analyze_image_basic(image_url, prompt)
